...
const HomePage = () => {
  ...
  const getBooks = async () => {
    try {
      console.log(
        `http://localhost:8080/api/book/findAll?writer=${filterValues.author}&genre=${filterValues.genre}&ratings=${filterValues.rating}`
      );
            ...
            {loggedIn ? (
              <>
                ...
                <button
                  ...
                  class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-2 py-1 text-center mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Logout
                </button>
              </>
