package com.kuku.kuku.repository;
...
public interface BookRepository extends JpaRepository<Book, Integer> {
	...
	List<Book> findBooksByRatingAndAuthor(@Param("writer") String writer,@Param("rating") Integer rating);
	...
	List<Book> findAllBooksByRating(@Param("rating") Integer rating);
	
	@Query("SELECT b from Book b WHERE b.writer=:writer AND b.rating=:rating AND b.genre=:genre")
	List<Book> findAllBooksByRatingAuthorGenre(@Param("writer") String writer,@Param("rating") Integer rating,@Param("genre") String genre);
	...
	List<Book> findBooksByRatingAndGener(@Param("rating") Integer rating,@Param("genre") String genre);
}
